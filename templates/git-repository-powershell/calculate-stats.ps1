...
((Get-Content -path fame.txt -Raw) -replace 'cort@eschaefer.net','cschaefer@enerbankusa.com') | Set-Content -Path fame.txt -encoding utf8
((Get-Content -path fame.txt -Raw) -replace 'mbrichards@enerbank.local','mbrichards@enerbankusa.com') | Set-Content -Path fame.txt -encoding utf8
((Get-Content -path fame.txt -Raw) -replace 'mauricioher.94@hotmail.com','maraica@enerbankusa.com') | Set-Content -Path fame.txt -encoding utf8
